...
def generate_sentences(data):
    ...
    for i, curr in enumerate(data):
        ...
        for event, event_dict in curr.items():
            ...
            sentence[event] = TEMPLATE_MAP[event].format(pronoun_1=pronoun_1, pronoun_2=pronoun_2, pronoun_3=pronoun_3,
                                                         last_name=last_name, **event_dict)
...
if __name__ == "__main__":
    input = [
        ...
        {"previous_work": {"start_year": "1989", "end_year": "1990", "name": "Glenwood Capital Investments",
                           "position": "treader"}},
        {"current_status": {"age": "53", "location": "Chicago, Illinois", "occupation": "CEO",
                            "company": "Citadel LLC"}},
